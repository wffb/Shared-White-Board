...
@Slf4j
public class OvalMouseListener implements MouseListener, MouseMotionListener {

    private RmiProcessor processor;
    ...
    public OvalMouseListener(Graphics2D graphics, Board board, JSlider slider, JPanel colorNow, JButton ovalButton, RmiProcessor processor) {
    ...
    public void mouseReleased(MouseEvent e) {
        ...
        try {
            Oval oval = new Oval(x1, y1, width,height, c, slider.getValue());
            oval.draw(graphics);

            //new shape
            processor.addShape(oval);

        }catch (RemoteException re) {
            log.error("Shape Oval add failed: "+re.getMessage());
        }
    ...
    public void mouseMoved(MouseEvent e) {
        ListenerTool.detectAndRemove(ovalButton,board,this);
    }
